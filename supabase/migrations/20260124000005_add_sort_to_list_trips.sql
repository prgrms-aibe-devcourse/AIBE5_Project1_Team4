-- Add sorting parameter to list_public_trips
-- Supports: 'latest' (default), 'popular' (by like_count)
...
BEGIN
  ...
  IF p_sort = 'popular' THEN
    ...
    -- For popular sort, we don't use cursor-based pagination (simpler approach)
