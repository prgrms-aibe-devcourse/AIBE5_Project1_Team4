...
const TripFilterPanel = ({ 
  ...
  return (
    <div className="filter-panel shadow-lg p-4 rounded-4" style={{ background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(10px)' }}>
      
      {/* 📍 [T-4012] 여행지 필터 섹션: 전체, 제주, 부산, 강릉, 도쿄 등 */}
      <div className="d-flex align-items-center mb-3 justify-content-center">
        <div className="text-white-50 small fw-bold me-3" style={{ width: '50px' }}>지역</div>
      ...
      <div className="d-flex align-items-center mb-3 justify-content-center">
        <div className="text-white-50 small fw-bold me-3" style={{ width: '50px' }}>테마</div>
        <div className="d-flex gap-2 flex-wrap justify-content-center" style={{ maxWidth: '600px' }}>
          {/* ✅ HomePage 데이터에 존재하는 '미식', '힐링', '관광'을 포함함 */}
          {['전체', '미식', '힐링', '관광', '액티비티', '쇼핑', '가족', '사진'].map(t => (
            <Button 
              key={t} size="sm" 
              ...
              style={{ 
                fontSize: '0.85rem',
                backgroundColor: selectedTheme === t 
                  ? (t === '전체' ? '#0d6efd' : '#8b5cf6') // 전체는 파랑, 나머지는 보라 포인트
                  : '#a1a1aa' 
              }}
      ...
      <div className="d-flex align-items-center justify-content-center">
        <div className="text-white-50 small fw-bold me-3" style={{ width: '50px' }}>기간</div>
        <div className="d-flex gap-2 flex-wrap">
